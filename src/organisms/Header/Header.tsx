...
import type { NavigationActionHandlers, NavigationLink, ModalOpenState } from "../../molecules/NavigationLinks/navLinkUtils";
...
const Header = ({ 
  ...
  return (
    <header className={headerClasses.join(" ")}>
        ...
        >
          <div className={styles.topBarContent}>
            <div className={styles.utilityGroup}>
              ...
              <span className={styles.governmentText}>Government of India</span>
            </div>
      ...
      <Section 
        contained={contained}
        spaceY={variant === "compact" ? "none" : "xs"} // dynamic spacing
      >
            ...
            {variant !== "auth" && (
              <div className={styles.headerRight}>
                ...
                {!isAuthenticated ? (
                    ...
                    <UserDropdown
                        user={{ name: "Mahesh Vhadadi", email: "mahesh@example.com", phone: "9876543210" }}
                        menuItems={[
                        { label: "My Profile", icon: "dashboard", onClick: () => {} },
